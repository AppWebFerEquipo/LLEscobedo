                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <form  action="{{route('pedidoswebentregar')}}" method="post">
                                        ...
                                        <button type="submit" style="background-color: rgb(190, 131, 21); color: white;" title="Pedido Entregado" >
                                ...
                                <div class="col-md-8">
                                    <form action="{{route('pedidoswebcancelar')}}" method="post">
                                        ...
                                        <button style="background-color: rgb(190, 21, 21); color: white;" title="Pedido Cancelado" >
